...
class SuspiciousCardTransferControllerIT extends TestContainerConfiguration {
    private static final Long NONEXISTENT_ID = 555L;
    private static final String PATH = "/suspicious/card/transfer";
    ...
    void readByIdPositiveTest() throws Exception {
        SuspiciousCardTransferDto expected = service.findById(transferDto.getId());
