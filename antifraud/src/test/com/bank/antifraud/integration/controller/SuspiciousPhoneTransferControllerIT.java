...
class SuspiciousPhoneTransferControllerIT extends TestContainerConfiguration {
    private static final Long NONEXISTENT_ID = 555L;
    private static final String PATH = "/suspicious/phone/transfer";
    ...
    void readByIdPositiveTest() throws Exception {
        SuspiciousPhoneTransferDto expected = service.findById(transferDto.getId());
    ...
    void createPositiveTest() throws Exception {
        mockMvc.perform(post(PATH + "/create")
                ...
                .andExpect(jsonPath("$.phoneTransferId",
                        Matchers.is(transferDto2.getPhoneTransferId().intValue())))
