...
class SuspiciousCardTransferServiceImplTest {
    ...
    private SuspiciousCardTransferEntity transfer;
    private SuspiciousCardTransferEntity transfer2;
    private SuspiciousCardTransferDto transferDto;
    private List<SuspiciousCardTransferEntity> transfers;
    ...
    void prepare() {
        ...
        transferDto = supplier.getTransferDto(25L, 30L, false, true,
                "A", "B");
        SuspiciousCardTransferDto transferDto2 = supplier.getTransferDto(35L, 40L, false,
                true, "A", "B");
    ...
    void savePositiveTest() {
        ...
        SuspiciousCardTransferDto actual = service.save(transferDto);
    ...
    void findByIdPositiveTest() {
        SuspiciousCardTransferDto actual = service.findById(transfer.getId());
