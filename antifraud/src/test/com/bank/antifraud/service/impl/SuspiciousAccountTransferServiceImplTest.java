...
class SuspiciousAccountTransferServiceImplTest {
    ...
    private SuspiciousAccountTransferEntity transfer;
    private SuspiciousAccountTransferEntity transfer2;
    private SuspiciousAccountTransferDto transferDto;
    private List<SuspiciousAccountTransferEntity> transfers;
    ...
    void prepare() {
        ...
        transferDto = supplier.getTransferDto(25L, 30L, false, true,
                "A", "B");
        SuspiciousAccountTransferDto transferDto2 = supplier.getTransferDto(35L, 40L, false,
                true, "A", "B");
    ...
    void savePositiveTest() {
        ...
        SuspiciousAccountTransferDto actual = service.save(transferDto);
    ...
    void findByIdPositiveTest() {
        SuspiciousAccountTransferDto actual = service.findById(transfer.getId());
    ...
    @Test
    @DisplayName("поиск по нескольким id равным null, негативный сценарий")
