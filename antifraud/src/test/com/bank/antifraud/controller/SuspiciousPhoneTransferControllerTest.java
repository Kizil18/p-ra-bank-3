...
class SuspiciousPhoneTransferControllerTest {
    private final static String PATH = "/suspicious/phone/transfer";
    ...
    void readByIdPositiveTest() throws Exception {
        ...
        mockMvc.perform(get(PATH + "/" + transferDto.getId().toString()))
                ...
                .andExpect(jsonPath("$.phoneTransferId",
                        Matchers.is(transferDto.getPhoneTransferId().intValue())))
    ...
    void readAllByIdPositiveTest() throws Exception {
        ...
        mockMvc.perform(get(PATH)
                ...
                .andExpect(jsonPath("$[0].phoneTransferId",
                        Matchers.is(transferDto.getPhoneTransferId().intValue())))
                ...
                .andExpect(jsonPath("$[1].phoneTransferId",
